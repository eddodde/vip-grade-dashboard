...
how_to("두 차트 모두 같은 데이터(전월→당월 이동)를 다르게 보여줍니다.<br>"
       ...
       "• <b>오른쪽 Sankey</b>: <b>왼쪽 마디=전월 등급, 오른쪽 마디=당월 등급</b>. 띠 "
       "하나 = '전월 A → 당월 B로 옮긴 사람', <b>띠 두께=인원</b>, "
       "<span style='color:#27AE60'>초록=승급</span>, "
       "<span style='color:#E74C3C'>빨강=하락</span>.<br>"
       "• <b>⚠️ 유지(같은 등급, 예: RD→RD)는 일부러 뺐습니다</b> — RD 유지가 ~350만이라 "
       "넣으면 다른 이동이 안 보이기 때문. 그래서 Sankey엔 <b>'등급이 바뀐 사람'만</b> "
       "나오고, 각 마디 높이는 그 등급에서 <b>나가거나 들어온 인원</b>(유지 제외)입니다.<br>"
